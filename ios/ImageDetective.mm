                  ...
                  withRejecter:(RCTPromiseRejectBlock)reject)
{
    [self UIImageForFilePath:filePath completion:^(NSArray *errorCodeMessageArray, UIImage *image) {
        ...
        NSInteger *classificationMode = (NSInteger *)[faceDetectorOptions[@"classificationMode"] pointerValue];
        ...
        NSInteger *contourMode = (NSInteger *)[faceDetectorOptions[@"contourMode"] pointerValue];
        ...
        NSInteger *landmarkMode = (NSInteger *)[faceDetectorOptions[@"landmarkMode"] pointerValue];
        ...
        NSInteger *performanceMode = (NSInteger *)[faceDetectorOptions[@"performanceMode"] pointerValue];
